...
.PHONY: index-image
index-image: opm
	$(GOPATH)/bin/opm index add -b quay.io/aditijadhav/compliance-operator-bundle:multi-arch -t quay.io/aditijadhav/compliance-operator-index:multi-arch  --generate
